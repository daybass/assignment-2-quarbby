...
with st.container():
    ...
    user_input = st.text_input("Keyword Filter")
...
with row4_1:
    ...
    st.write(wordcloud_before.words_)

with row4_2:
    st.write('After Elections')
    ...
    st.write(wordcloud_after.words_)
